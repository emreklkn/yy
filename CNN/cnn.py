...
train_datagen = ImageDataGenerator(rescale = 1./255, #image data generator bize her seferrinde 1 resim okuyacak
                                   shear_range = 0.2,
                                   zoom_range = 0.2,
...
training_set = train_datagen.flow_from_directory('veriler/training_set',
                                                 target_size = (64, 64),# yaptığı resimide 64 e 64 şeklinde olucak
                                                 batch_size = 1,
                                                 class_mode = 'binary')
